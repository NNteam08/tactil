...
export function PartnerApplyForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const org_name = (form.elements.namedItem("org_name") as HTMLInputElement)?.value ?? "";
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <label className="flex flex-col gap-1.5">
        ...
        <input type="text" name="org_name" className={inputClass} placeholder="School, NGO, etc." />
      </label>
      <label className="flex flex-col gap-1.5">
      ...
      <label className="flex flex-col gap-1.5">
        ...
        <input type="text" name="region" className={inputClass} placeholder="Country or region" />
      </label>
      <label className="flex flex-col gap-1.5">
